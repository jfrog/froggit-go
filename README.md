...
- [Froggit-Go](#froggit-go)
  ...
  - [Usage](#usage)
    - [VCS Clients](#vcs-clients)
      ...
      - [Upload Code Scanning With Ref](#upload-code-scanning-with-ref)
...
// The name of the repository
repo := "my_repo"
// The ref for which the code scanning is relevant
ref := "refs/pull/123/head"
// The commit SHA
commitSHA := "5c05522fecf8d93a11752ff255c99fcb0f0557cd"
// A string representing the code scanning results
scanResults := "results"

// Uploads the scanning analysis file to the relevant git provider with a specific ref and commit SHA
sarifID, err := client.UploadCodeScanningWithRef(ctx, owner, repo, ref, commitSHA, scanResults)
```
